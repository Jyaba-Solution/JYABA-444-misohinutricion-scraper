...
class MisohinutricionSpiderSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.misohinutricion.com/necesidades-especificas.html','https://www.misohinutricion.com/categorias.html',
    'https://www.misohinutricion.com/ingredientes.html','https://www.misohinutricion.com/marcas.html','https://www.misohinutricion.com/ingredientes.html']
    ...
    def parse_page(self, response):
        ...
        if next_page:
            ...
            yield scrapy.Request(next_page, callback=self.parse_page, meta={'next_page_checker': True})
        elif product_list:
